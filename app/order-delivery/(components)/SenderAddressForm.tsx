...
import { useSenderAddressForm } from "../(hooks)/useSenderAddressForm";

export const SenderAddressForm = memo(() => {
    const intl = useI18n();
    const { form, onSubmit } = useSenderAddressForm();
    ...
    useEffect(() => {
        if (
            ...
            updateFormData("senderAddress", formValues);
